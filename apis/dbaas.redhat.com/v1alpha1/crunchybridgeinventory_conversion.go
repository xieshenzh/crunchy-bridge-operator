...
// ConvertTo converts this CrunchyBridgeInventory to the Hub version (v1alpha2).
func (src *CrunchyBridgeInventory) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*dbaasredhatcomv1alpha2.CrunchyBridgeInventory)
...
func (dst *CrunchyBridgeInventory) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dbaasredhatcomv1alpha2.CrunchyBridgeInventory)
