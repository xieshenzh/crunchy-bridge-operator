...
// ConvertTo converts this CrunchyBridgeConnection to the Hub version (v1alpha2).
func (src *CrunchyBridgeConnection) ConvertTo(dstRaw conversion.Hub) error {
	dst := dstRaw.(*dbaasredhatcomv1alpha2.CrunchyBridgeConnection)
...
func (dst *CrunchyBridgeConnection) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dbaasredhatcomv1alpha2.CrunchyBridgeConnection)
